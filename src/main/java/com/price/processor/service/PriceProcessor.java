...
public interface PriceProcessor {
	...
	/**
	 * Cancel current onPrice operation.
	 *
	 * @return <code>true</code> if operation already succeeded, <code>false</code> otherwise
	 */
	// I added this because I don't think that it's normal to not have a 'gracefully shutdown' method.
	boolean cancel();
}